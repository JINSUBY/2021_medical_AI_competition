...
TRAIN_DATA_JSON_PATH = "/home/jinsuby/Desktop/PycharmProjects/data/Kia/Kia_coco_thick_4/Kia_trainval_cocoformat.json"
TRAIN_DATA_IMG_PATH = "/home/jinsuby/Desktop/PycharmProjects/data/Kia/Kia_coco_thick_4/JPEGimages"
...
cfg.OUTPUT_DIR = "./output/" + TRAIN_DATA + "-eps" + cfg.SOLVER.MAX_ITER + "-thresh" + cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST
os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)
